        ...
        <section class="section-plans">
            <div class="row">
                ...
                <a style="text-decoration: none; color: white;" href="emordview.php">
                    <div class="col span-5-of-11" style="border-radius:5px;box-shadow: 4px 4px 10px rgba(12, 10, 72, 0.15); text-align: center; padding: 1%;border: 2px solid #3f184f;background-color: #3f184f;">
                        ORDER HISTORY
                    </div>
                </a>
            </div>
