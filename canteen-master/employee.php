    ...
    <section id="section0">
        <div class="myrow">
          ...
          <div class="column2">
                    ...
                    <div class="card">
                        <nav style="text-align:center" class="nav-extended btncolor">
                            
                            <div class="nav-content ">
                              <ul class="tabs tabs-transparent">
                                <li class="tab" style="margin-left:40%"><a class="active">Employee</a></li>
                              </ul>
                            </div>
                          </nav>
                              ...
                              <div class="row">
                                  <form class="col s12" method="POST" action = "">
                                    ...
                                    <div class="row">
                                      ...
                                      <input type="submit" value="LOGIN" class=" btn btn-dark btncolor center ">
                                  </form>
                                </div>                             
                          </div>
              </div>
